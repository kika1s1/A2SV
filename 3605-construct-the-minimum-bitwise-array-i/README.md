<h2><a href="https://leetcode.com/problems/construct-the-minimum-bitwise-array-i">Construct the Minimum Bitwise Array I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given an array <code>nums</code> consisting of <code>n</code> <span data-keyword="prime-number">prime</span> integers.</p>
